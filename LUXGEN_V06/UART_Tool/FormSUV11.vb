...
#Region " Create New Barcode "
    Private Function Create_New_Barcode() As String
        ...
        Dim last_barcode As String = _
            myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(1) & Format((Now.Year - 2000), "00") & Format(Now.Month, "00") & "0000"
        ...
        m = Now.Month
        returnValue = _
            myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(1) & Format(y, "00") & Format(m, "00") & Format(sn, "0000")
        Return returnValue
    End Function
#End Region
...
#Region " Write New Data "
    Private Sub WriteNewData()
        ...
        device_id = myData.SQL_Insert_Device(br, Me.TextBox4.Text, Me.TextBox5.Text, 1)
        ...
        If (CRC16_Check(read) = True) Then
            ...
            ElseIf test_step = 25 Then
                ...
                If Me.AmpControl1.Amp_Fix = True Then
                    ...
                    Me.CheckBox2.Checked = False
                    'Current Limit
                    Dim cl As Double = myINI.Section("Current Limit").Key("SUV_Limit").Value
            ...
            If test_step = 21 Then
                Me.TextBox4.Text = myINI.Section("Version Mapping").Key(myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(1) & error_step).Value
                Me.TextBox5.Text = myINI.Section("Firmware Mapping").Key(myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(1) & error_step).Value
            End If
...
#Region " Menu "
    ...
    Private Sub 條碼列印測試ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 條碼列印測試ToolStripMenuItem.Click
        Dim myTSC As New ClassTSC("IT-82XXX-XX", "SS12345678", "SS12345678")
        myTSC.DC_PrintLabel()
        myTSC.Dispose()
    End Sub
#End Region
    ...
    Private Sub 版本測試ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 版本測試ToolStripMenuItem.Click
        ...
        Dim vr As String = myINI.Section("Version Mapping").Key(myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(1) & input).Value
        MsgBox(vr)
    End Sub
End Class