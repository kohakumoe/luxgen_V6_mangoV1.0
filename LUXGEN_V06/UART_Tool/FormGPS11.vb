...
#Region " Create New Barcode "
    Private Function Create_New_Barcode() As String
        ...
        Dim table As DataTable = myData.SQL_Select_Last_Device_By_產品類別識別碼(2)
        Dim last_barcode As String = _
            myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(2) & Format((Now.Year - 2000), "00") & Format(Now.Month, "00") & "0000"
        ...
        m = Now.Month
        returnValue = _
            myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(2) & Format(y, "00") & Format(m, "00") & Format(sn, "0000")
        Return returnValue
    End Function
#End Region
...
#Region " Write New Data "
    Private Sub WriteNewData()
        ...
        device_id = myData.SQL_Insert_Device(br, Me.TextBox4.Text, Me.TextBox5.Text, 2)
    ...
    Private Sub d()
        If (CRC16_Check(read) = True) Then
            ...
            If test_step = 15 Then
                Me.TextBox4.Text = myINI.Section("Version Mapping").Key(myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(2) & error_step).Value
                If Me.TextBox4.Text = "" Then
                    Me.TextBox4.Text = "沒有對應版次"
                End If
                Me.TextBox5.Text = myINI.Section("Firmware Mapping").Key(myData.SQL_SELECT_產品類別顯示條碼_BY_辨識碼(2) & error_step).Value
                If Me.TextBox5.Text = "" Then
                    Me.TextBox5.Text = "沒有對應版次"
                End If
            End If
            If test_step = 100 Then
                ...
                ElseIf error_step = 11 Then
                    Me.TextBox3.Text = "可能NG迴路" & vbNewLine & "SPEED OFF"
                    Me.TextBox3.ForeColor = Color.Red
                ElseIf error_step = 12 Then
                    Me.TextBox3.Text = "可能NG迴路" & vbNewLine & "SPEED檔 ON"
                    Me.TextBox3.ForeColor = Color.Red
